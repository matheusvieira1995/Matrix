...
import Matrix.modelo.Human;
import Matrix.modelo.Matrix;
import Matrix.modelo.Person;
import Matrix.modelo.Program;
import Matrix.modelo.Ship;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Até aqui foi 2");
		...
		System.out.println("Até aqui foi 3");
		// 3ra parte: ---------- 
		...
		System.out.println("Até aqui foi 4");
		// 4ta parte: -------- 
		...
		System.out.println("Até aqui foi 5");
		...
		System.out.println("Até aqui foi 6");
		...
		System.out.println("Até aqui foi 7");
		...
		System.out.println("Até aqui foi 8");
		/* 8va parte: ------------------ */
		...
		System.out.println("Até aqui foi 9");
